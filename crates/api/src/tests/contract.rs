...
const EXPECTED: &[(&str, &str)] = &[
    ...
    ("create_memory_node", "M3c"),
    ("delete_mcp_server", "M6"),
    ("delete_memory_node", "M3c"),
    ("delete_skill", "M6"),
    ("get_agents_md", "M3c"),
    ("get_catalog", "M4"),
    ("get_mcp_server", "M6"),
    ...
    ("get_repo_status", "M3c"),
    ("get_session_env", "M3c"),
    ("get_session_machine", "M4"),
    ("get_skill", "M6"),
    ("interrupt_session", "M3c"),
    ("link_provider", "M4"),
    ("list_harness_accounts", "M4"),
    ("list_mcp_servers", "M6"),
    ("list_memory", "M3c"),
    ("list_providers", "M4"),
    ("list_repos", "M6"),
    ...
    ("list_turns", "M3c"),
    ("llm_usage", "M6"),
    ("provider_quickstart", "M4"),
    ("put_agents_md", "M3c"),
    ("put_session_env", "M3c"),
    ("receive_github_webhook", "M6"),
    ("register_mcp_server", "M6"),
    ("resize_session_machine", "M4"),
    ("resume_session", "M4"),
    ("send_message", "M3c"),
    ("start_harness_link", "M4"),
    ("start_session_machine", "M4"),
    ("stop_session_machine", "M4"),
    ("subscribe_push", "M5"),
    ("unlink_harness_account", "M4"),
    ("unlink_provider", "M4"),
    ("unsubscribe_push", "M5"),
    ("update_mcp_server", "M6"),
    ("update_memory_node", "M3c"),
    ("upload_skill", "M6"),
    ("vapid_public_key", "M5"),
];
